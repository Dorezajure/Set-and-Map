...
// Задание №1
let events = Array.froms(new Set(gameEvents.values()));
console.log(events);

// //Задание №2
let events2 = gameEvents.delete(64);
console.log(events2);

// Задание №3
console.log(`Каждое событие в матче появлялось в среднем раз в ${90 / gameEvents.size} в минут`);
